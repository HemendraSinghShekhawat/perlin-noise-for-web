    ...
    for (let i = 0; i < verticalColCount; i++) {
      for (let j = 0; j < horizontalCount; j++) {
        const vect = new Vector2(
          (i * canvas.width) / verticalColCount +
            (Math.random() * canvas.width * 0.5) / verticalColCount,
          (j * canvas.height) / horizontalCount +
            (Math.random() * canvas.width * 0.5) / verticalColCount,
        );
        //const scaler = vect.setScalar(10);
        //const polarVect = vect.setPolar(Math.random(), 10);
        ctx.beginPath();
        ctx.moveTo(
          (i * canvas.width) / verticalColCount,
          (j * canvas.height) / horizontalCount,
        ...
        ctx.strokeRect(
          (i * canvas.width) / verticalColCount,
          (j * canvas.height) / horizontalCount,
          canvas.width / verticalColCount,
          canvas.height / horizontalCount,
        );
      }
    }
  }
